...
%% v2.0 — Structural rewrite: all lists converted to prose, scientific language tightened
%% Journal-agnostic format (adapt to target journal before submission)
%% Changes from v1.0: bullet points eliminated, informal phrasing replaced,
%%   Copernicus-specific macros removed, section flow improved
