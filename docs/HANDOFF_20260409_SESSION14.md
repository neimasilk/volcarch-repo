...
- Submission ID: **365**
- Portal: https://submission.archcalc.cnr.it/submission/365
- Diamond OA, zero APC, double-blind, Scopus+WoS
- 3 limitasi baru: cascade underdetermination, karst confound, spatial autocorrelation
- Confirmation email received

### 3. 11 Eksperimen Baru (E176-E186)

| ID | Temuan | Status |
|----|--------|--------|
| E176 | Cascade 3-faktor cukup. 83.8% random draws bracket. | SUCCESS |
| E177 | L2 pertama: 250K displaced, 5 entry-point predictions | SUCCESS |
| E178 | Karst = faktor ke-6. Filipina 25 sites vs Jawa 0. | SUCCESS |
| E179 | Factor coupling 3.0x, dalam uncertainty | SUCCESS |
| E181 | Ghost Dictionary: 47 kata, 55% OJ, admin terbesar | SUCCESS |
| E182 | Karst-augmented cascade: rank rho 0.32->0.50 | SUCCESS (PARTIAL) |
| E183 | Register split = origin ngoko/krama. NOVEL. | SUCCESS |
| E184 | Spatial autocorrelation WARNING. Regression collapse. | INFO NEG |
| E185 | Two Javas ROBUST: Cohen's d~2.0 | SUCCESS |
| E186 | Tengger ghost cross-ref. ABVD terlalu terbatas. | INCONCLUSIVE |
...
| L2 experiments | 2 | **3** |
| Cathedral findings | 13 | **10** (honest recount) |
| Novel findings | — | **3** (karst, register split, cascade over-param) |
...
| Item | Status | Next |
|------|--------|------|
| **Aubert response** | SENT 2026-04-08, WAIT | If positive -> ARC Linkage |
| **Leiden KITLV email** | DRAFTED | Pak Amien review + send |
| **JCAA waiver** | Verhagen acknowledged | WAIT |
| **P17 ArchCalc** | SUBMITTED | WAIT for editor assignment |
| **P11 Archipel** | SUBMITTED | WAIT |
...
## 3 TEMUAN PALING PENTING SESI INI

1. **Sanskritisasi = Krama-ifikasi** (E183). Ghost words dari C7-C9 tidak hilang — mereka pindah dari register tulis ke register lisan. Modern ngoko/krama dimulai di prasasti C9-C10. Ini temuan genuinely novel yang belum ada di literatur.
