% Internet Archaeology — Submission v0.1
% Adapted from JAS:Reports v0.1
% Internet Archaeology: digital, open access, peer-reviewed
% Accepts LaTeX; editorial team handles final formatting
...
The archaeological site dataset, DEM derivatives, and analysis scripts are available at \url{https://github.com/neimasilk/volcarch-repo}. Raw DEM data from Copernicus GLO-30 are publicly available at \url{https://dataspace.copernicus.eu/}. An interactive dashboard for exploring settlement suitability model predictions is available at \url{https://volcarch-dashboard.streamlit.app}.

\section*{Code Availability Statement}

All analysis scripts (E001--E006) are available in the project repository under \texttt{experiments/}. Software: Python 3.11+, geopandas, rasterio, scikit-learn. Full dependencies in \texttt{requirements.txt}.
