...
| I-124 | Cerén (El Salvador) as volcanic preservation analog | READY | None — literature review only | N/A | Blind spot analysis 2026-03-21 | P1, P19, Channel 1 | *Complete pre-Columbian village buried by Loma Caldera (~600 CE). Preserved food, thatch, cloth. Closest analog to what VOLCARCH predicts for pre-Hindu Java. Key ref: Sheets 1992, 2002.* |
| I-125 | Phytolith survival in volcanic soil (escalation of I-082) | HYPOTHESIS | Needs literature review on alkaline ash + phytolith preservation | Literature compiled | Blind spot analysis 2026-03-21 | P1, P10, Channel 1 | *Phytoliths (silica plant casts) may survive volcanic burial. If so, they could establish pre-Hindu agricultural presence at depth without macroscopic artifacts. Potentially transformative research direction. Could become P20.* |
