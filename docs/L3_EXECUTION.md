...
**Status:** COMPLETE (2026-02-24) â€” full draft v0.2 in `papers/P1_taphonomic_framework/draft_v0.1.md`
**Description:** Write full first draft of Paper 1.
**Title:** "A Framework for Estimating Volcanic Taphonomic Bias in Indonesian Archaeological
Records: The Dwarapala Case Study"
**Structure:**
  1. Introduction â€” absence-of-evidence problem in volcanic Java
  2. The Dwarapala calibration â€” only quantitative empirical data point
  3. Computational framework â€” sedimentation model + burial depth estimates
  4. E004/E005 results â€” why distribution data cannot test H1
  5. Test site prediction â€” framework output (map of high-suitability buried-site candidates)
  6. Discussion â€” limitations, fieldwork recommendations
  7. Conclusion â€” H1 as hypothesis; need for stratigraphic evidence
...
**Status:** PENDING
**Description:** Manual download required (GVP serves HTML, not CSV via GET).
**Instructions:**
  1. Go to https://volcano.si.edu/database/search_eruption_excel.cfm
  2. Search for each volcano by number: Kelud (263280), Semeru (263300),
     Arjuno-Welirang (263260), Bromo (263310)
  3. Export Excel â†’ save to `data/raw/gvp/gvp_<id>.xlsx`
  4. Re-run: `python experiments/E002_eruption_history/01_compile_eruptions.py`
**Notes:** Currently running on 8 seed records only; full GVP has 100+ documented events

---

## Upcoming Tasks (Backlog â€” Sprint 2)

- TASK-012: **Survey intensity normalization** â€” BPCB excavation report coverage per kmÂ²
  (needed to properly normalize E004 site density by survey effort)
- TASK-013: **Survey intensity normalization** â€” BPCB excavation report coverage per kmÂ²
  (needed to properly normalize E004 site density by survey effort)
...
| E002 | Eruption history compilation | PARTIAL | P1, P3 | 8 seed records; needs full GVP |
