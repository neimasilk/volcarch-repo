% SPAFA dual-language: Indonesian title/abstract/keywords to be added in Word version (see SPAFA_DUAL_LANGUAGE_20260813.md).
...
\vspace{1em}
\noindent\textbf{Judul (Bahasa Indonesia):} Candi Tanpa Desa: Candi dan Geografi Permukiman yang Tersembunyi di Jawa Vulkanik

\vspace{0.5em}
\begin{abstract}
Lanskap vulkanik Jawa telah mengubur berabad-abad permukiman manusia di bawah endapan piroklastik. Kami berargumen bahwa candi-candi Hindu-Buddha yang bertahan menandai lokasi komunitas-komunitas yang hilang tersebut. Analisis spasial terhadap 142 candi mengungkap pengelompokan yang sistematis di sisi barat gunung api--zona yang paling intensif tertimbun lahar dan tefra--sementara orientasi candi mengikuti ketentuan keagamaan. Prasasti yang ter-georeferensi menempati zona spasial yang berbeda, mengelompok 15--30~km dari gunung api, tempat istana kerajaan beroperasi. Divergensi ini menyingkap dua geografi yang berbeda: lanskap sakral di lereng gunung dan lanskap administratif di dataran aluvial. Runtuhnya Mataram pada 929~M memberikan pengamatan sebelum-sesudah yang mengonfirmasi struktur spasial ini, dan penemuan desa terkubur di Liangan pada 2008 menunjukkan keplausibelan model tersebut. Jawa pra-modern jauh lebih luas permukimannya daripada yang tersirat dalam rekaman yang bertahan.
\end{abstract}

\vspace{0.5em}
\noindent\textbf{Kata kunci:} Jawa, candi, tafonomi vulkanik, geografi permukiman, prasasti, arkeologi Hindu-Buddha, Nusantara, lanskap terkubur
...
Lombard's magisterial portrait of the ``Javanese crossroads'' drew upon inscriptions, temple complexes, and literary texts--all products of elite patronage, all rendered in durable media (Lombard 1990).
...
Lombard's third volume, \emph{Les r\'{e}seaux}, traced the commercial and cultural networks that converged on Java, but beneath these layers of Indian, Chinese, and Islamic influence he repeatedly acknowledged a deeper stratum: the \emph{monde du village}, the Austronesian substrate of rice cultivation, ancestor worship, and communal organisation that persisted through every successive wave of external contact (Lombard 1990: vol. 3, esp. chaps 9--10).\footnote{On the persistence of village structures beneath successive ``r\'{e}seaux.''}
...
When Wolters described the ``localization'' of Indic culture in Southeast Asia--the creative process by which imported cultural elements were absorbed and transformed by local societies--he worked primarily from inscriptions and temples (Wolters 1999).
...
Miksic has noted the paradox directly: Java's archaeological record is simultaneously one of the richest in Southeast Asia in monumental terms and one of the most incomplete in settlement terms (Miksic 2004: 234--256).
De Casparis, mapping the distribution of inscriptions across Java, observed that they clustered in areas associated with court activity--the Kedu plain, the Prambanan basin, the Brantas valley--while the volcanic highlands remained ``comparatively inscription-free'' (de Casparis 1975).
...
The island hosts 34 of Indonesia's 127 active volcanoes, erupting on average once every 1--2 years (Global Volcanism Program 2023; Whitten et al.\ 1996). Throughout this paper, volcano locations follow the canonical 30-peak inventory of active and recently active Java volcanoes (Smithsonian GVP-derived), replacing the partial inventories used in earlier project work.
Merapi alone has produced more than 60 eruptions in the last millennium (Newhall et al.\ 2000: 9--50).

The archaeological consequence is progressive burial.
Unlike the catastrophic single-event burial at Pompeii or Akrotiri, Java's temples and settlements were buried by cumulative deposition--repeated small to moderate events (lahars, tephra falls, pyroclastic surges) accumulating over centuries (Lavigne and Thouret 2003: 45--69).
...
The \emph{Oudheidkundig Verslag} reports of 1912--1929 record numerous instances of archaeological structures found at depth: temples near Kelud under 2~m of lahar deposit, Trowulan structures at 3.5--4.3~m, a Vi\d{s}\d{n}u statue at Prambanan at 9.14~m below the modern surface (Oudheidkundig Verslag 1912--1929; see also van Bemmelen 1949).
The discovery of Candi Sambisari in 1966 at 6.5~m depth, and Candi Kimpulan in 2009 at 2.5~m, confirmed that significant Hindu-Buddhist structures can be completely concealed within centuries of abandonment (Putra and Setyastuti 2019: 377--402).

This taphonomic process is not random.
It preferentially erases evidence from the zones closest to volcanoes: the very areas that, in Mohr's analysis, supported the highest population densities due to the exceptional fertility of volcanic soils (Mohr 1938).
...
Of the 142 candi for which coordinates were compiled from published surveys, heritage registries, and standard catalogues (Dumar\c{c}ay 1993; Soekmono 1995), most are visible at the surface today, and others were rediscovered through excavation--Sambisari in 1966 and Kimpulan in 2009, each buried for centuries before its discovery.
They are, in Schiffer's terminology, products of differential formation processes: what survives is what resists (Schiffer 1987).
...
De Groot's spatial analysis of Central Javanese candi demonstrated that temples were oriented toward and clustered near major volcanoes, particularly Merapi and Penanggungan (de Groot 2009).
A quantitative test of this co-location strengthens the claim: of 108 non-temple archaeological sites in East Java, 81 per cent lie within 10~km of the nearest candi, with a mean distance of 6.8~km.\footnote{Monte Carlo simulation ($p < 0.0001$, 10,000 permutations) confirms that the observed candi-settlement proximity cannot be explained by chance clustering.}
...
The mean bearing is 298\textdegree{} (west-northwest), with nearly half of all candi (47.9 per cent) on western flanks; the eastern quadrant contains under 10 per cent.\footnote{Rayleigh test for circular non-uniformity: $p = 1.2 \times 10^{-9}$.}
...
In the \emph{\'{S}aiva-siddh\={a}nta} tradition that shaped Javanese temple architecture, mountains are identified with the cosmic Mount Meru, axis of the universe and abode of the gods (Kinney et al.\ 2003).
...
De Groot's analysis of Central Javanese candi demonstrated that temples were not merely placed near volcanoes but positioned to maintain specific visual relationships with volcanic peaks--what she termed ``intervisibility'' between sacred structure and mountain summit (de Groot 2009: chaps 5--6).
Kinney, Klokke, and Kieven have shown that the iconographic programs of East Javanese temples encode directional cosmology: relief narratives progress in specific sequences around the building, calibrated to the cardinal orientation of the entrance (Kinney et al.\ 2003: 42--68).
...
Zone A (within 10~km of a volcanic peak) contains 45.1 per cent (64 of 142) of all candi--an overrepresentation of 19.1$\times$ relative to land area.
Penanggungan alone hosts 73 candi, 63 per cent on its western flank.
...
We georeferenced 182 inscriptions from the DHARMA epigraphic database (DHARMA project 2024), of which the 175 located on Java and Bali form the analysis set, re-derived against the canonical 30-volcano inventory.

The contrast is stark.
Inscriptions are on average 6.1~km farther from volcanoes than candi.\footnote{Mann-Whitney $U$ test: $p = 2.8 \times 10^{-7}$.}
While 45.1 per cent of candi lie in Zone A (within 10~km of a volcano), only 13.1 per cent of inscriptions do.
...
Inscriptions are textual, administrative, and court-produced--records of \emph{sima} (tax-free) land grants, royal genealogies, and boundary demarcations in Sanskrit formulaic prose (de Casparis 1975: 15--42).
...
Scholars have routinely used inscription counts as proxies for population density, political complexity, or the reach of ``Indianization'' (Coed\`{e}s 1968).
...
The causes of the Mataram collapse remain debated--Merapi eruptions, political conflict, economic reorganisation--but the consequences for the inscriptional record are well documented (Christie 2001: 25--55; see also Hall 2011).

Before 929~CE, 58 per cent of dated and georeferenced inscriptions ($n=100$) are located in the court zone, and 91 per cent of those court-zone inscriptions are Sanskrit-dominant.
After 929, 48 per cent ($n=31$) appear in the periphery ($>$30~km from volcanoes), and 87 per cent of those are mixed or indigenous-rich in vocabulary.\footnote{Percentages re-derived 2026-08-13 on the canonical 30-volcano inventory (E105 canonical-30 re-run); the earlier partial-inventory run gave 57/91/53/89 per cent.}

This shift has traditionally been interpreted as ``de-Indianization'' or ``Javanization''--a civilisation-wide retreat from Indic cultural forms (Kulke 1990; Pollock 2006).\footnote{On the Indianization debate and its critiques.}
...
Her ``states without cities'' argument held that early Javanese polities were not urban in any conventional sense: political power was exercised through dispersed control of wet-rice agricultural production, not through concentrated urban populations (Christie 1991: 23--40).
...
Located 5.5~km from Mount Sindoro on its western flank--Zone A, western quadrant--the site was found not by archaeologists but by sand miners, who exposed a complete Mataram-era settlement beneath 4--6~m of pyroclastic deposits (Abbas 2016).
...
The closest analogue is Cerén in El Salvador, the Central American village sealed by a single eruption c.~600~CE that preserved sleeping mats, stored food, and agricultural tools (Sheets 2002).
...
Indonesia's rescue archaeology capacity is minimal by international standards: approximately 70 excavations per year, compared to Japan's 8,300 (Takata and Yanase 2022).
The mechanisms by which buried sites become known elsewhere--developer-funded excavation, systematic geophysical survey, ground-penetrating radar reconnaissance (Conyers 2004)--have not been deployed at scale in Indonesian volcanic zones.
...
As Bloembergen and Eickhoff have documented, the colonial \emph{Oudheidkundige Dienst} constructed its archaeological priorities around monumental Hindu-Buddhist remains--candi, inscriptions, relief panels--that served the colonial narrative of a pre-Islamic ``golden age'' (Bloembergen and Eickhoff 2020: chaps 2--4).\footnote{On colonial archaeological priorities and their postcolonial persistence.}
...
The convergence of these evidence lines--candi clustering on western volcanic flanks, the inscription-architecture divergence, documented burial depths of 2--9~m, the Liangan discovery, and the survey-intensity control--points toward a single conclusion: pre-modern Java was far more extensively settled in volcanic zones than the surviving record indicates.
...
The Penanggungan concentration (51 per cent of all candi) limits spatial generalisability, though the pattern survives its exclusion.
...
\noindent AI tools (Claude, Anthropic, versions 4 and 5) were used between February and August 2026 for spatial geocoding, statistical computation assistance, and editorial refinement of the manuscript. All statistical analyses were independently verified using standard libraries (SciPy, GeoPandas). Research design, hypothesis formation, data interpretation, and all conclusions are the authors' work. Figures are programmatic plots (matplotlib) of author-compiled data; no AI-generated imagery was used. Code and data are available at the project repository.
...
\noindent Abbas, N. (ed.) (2016) \emph{Liangan: Mozaik Peradaban Mataram Kuno di Lereng Sindoro}. Yogyakarta: Kepel Press/Balai Arkeologi Yogyakarta.

\vspace{0.5em}
\noindent Bloembergen, M., and Eickhoff, M. (2020) \emph{The Politics of Heritage in Indonesia: A Cultural History}. Cambridge: Cambridge University Press.

\vspace{0.5em}
\noindent de Casparis, J.G. (1975) \emph{Indonesian Palaeography: A History of Writing in Indonesia from the Beginnings to c.~A.D.~1500}. Leiden: E.J. Brill.

\vspace{0.5em}
\noindent Christie, J.W. (1991) `States without Cities: Demographic Trends in Early Java.' \emph{Indonesia} 52: 23--40.

\vspace{0.5em}
\noindent Christie, J.W. (2001) `Revisiting early Mataram.' In Klokke, M.J. and van Kooij, K.R. (eds) \emph{Fruits of Inspiration: Studies in Honour of Prof. J.G. de Casparis}. Groningen: Egbert Forsten, 25--55.

\vspace{0.5em}
\noindent Coed\`{e}s, G. (1968) \emph{The Indianized States of Southeast Asia}. Translated by Susan Brown Cowing. Honolulu: University of Hawai'i Press.

\vspace{0.5em}
\noindent Conyers, L.B. (2004) \emph{Ground-Penetrating Radar for Archaeology}. Walnut Creek: AltaMira Press.

\vspace{0.5em}
\noindent de Groot, V.M.Y. (2009) \emph{Candi, Space and Landscape: A Study on the Distribution, Orientation and Spatial Organization of Central Javanese Temple Remains}. PhD diss., Leiden University.

\vspace{0.5em}
\noindent DHARMA project (2024) \emph{The Domestication of ``Hindu'' Asceticism and the Religious Making of South and Southeast Asia: Epigraphic Database}. CNRS/ERC. \url{https://dharma.hypotheses.org/}

\vspace{0.5em}
\noindent Dumar\c{c}ay, J. (1993) \emph{The Temples of Java}. Oxford: Oxford University Press.

\vspace{0.5em}
\noindent Global Volcanism Program (2023) \emph{Volcanoes of the World}. V. 5.1.1. Smithsonian Institution. \url{https://volcano.si.edu/}

\vspace{0.5em}
\noindent Hall, K.R. (2011) \emph{A History of Early Southeast Asia: Maritime Trade and Societal Development, 100--1500}. Lanham: Rowman \& Littlefield.

\vspace{0.5em}
\noindent Kinney, A.R., Klokke, M.J., and Kieven, L. (2003) \emph{Worshipping \'{S}iva and Buddha: The Temple Art of East Java}. Honolulu: University of Hawai'i Press.

\vspace{0.5em}
\noindent Kulke, H. (1990) `Indian Colonies, Indianization or Cultural Convergence? Reflections on the Changing Image of India's Role in South-East Asia.' In Becker, H. and Ptak, R. (eds) \emph{Unterwegs nach Indien}. Munich: Museum f\"{u}r V\"{o}lkerkunde.

\vspace{0.5em}
\noindent Lavigne, F., and Thouret, J.-C. (2003) `Sediment Transportation and Deposition by Rain-Triggered Lahars at Merapi Volcano, Central Java, Indonesia.' \emph{Geomorphology} 49(1--2): 45--69.

\vspace{0.5em}
\noindent Lombard, D. (1990) \emph{Le carrefour javanais: essai d'histoire globale}. 3 vols. Paris: \'{E}ditions de l'\'{E}cole des hautes \'{e}tudes en sciences sociales.

\vspace{0.5em}
\noindent Miksic, J.N. (2004) `The Classical Cultures of Indonesia.' In Glover, I. and Bellwood, P. (eds) \emph{Southeast Asia: From Prehistory to History}. London: RoutledgeCurzon, 234--256.

\vspace{0.5em}
\noindent Mohr, E.C.J. (1938) `The Relation between Soil and Population Density in the Netherlands East Indies.' In \emph{Comptes Rendus du Congr\`{e}s International de G\'{e}ographie}. Amsterdam.

\vspace{0.5em}
\noindent Newhall, C.G., Bronto, S., Alloway, B., Banks, N.G., Bahar, I., del Marmol, M.A., Hadisantono, R.D., Holcomb, R.T., McGeehin, J., Miksic, J.N., Rubin, M., Sayudi, S.D., Sukhyar, R., Andreastuti, S., Tilling, R.I., Torley, R., Trimble, D. and Wirakusumah, A.D. (2000) `10,000 Years of Explosive Eruptions of Merapi Volcano, Central Java: Archaeological and Modern Implications.' \emph{Journal of Volcanology and Geothermal Research} 100(1--4): 9--50.

\vspace{0.5em}
\noindent \emph{Oudheidkundig Verslag} (1912--1929) Batavia: Oudheidkundige Dienst in Nederlandsch-Indi\"{e}.

\vspace{0.5em}
\noindent Pollock, S. (2006) \emph{The Language of the Gods in the World of Men: Sanskrit, Culture, and Power in Premodern India}. Berkeley: University of California Press.

\vspace{0.5em}
\noindent Putra, P.B., and Setyastuti, A. (2019) `Le complexe cultuel de Kimpulan, site enfoui sous les cendres du Merapi (Yogyakarta, Java central).' \emph{Bulletin de l'\'{E}cole fran\c{c}aise d'Extr\^{e}me-Orient} 105: 377--402.

\vspace{0.5em}
\noindent Schiffer, M.B. (1987) \emph{Formation Processes of the Archaeological Record}. Albuquerque: University of New Mexico Press.

\vspace{0.5em}
\noindent Sheets, P.D. (ed.) (2002) \emph{Before the Volcano Erupted: The Ancient Cer\'{e}n Village in Central America}. Austin: University of Texas Press.

\vspace{0.5em}
\noindent Soekmono, R. (1995) \emph{The Javanese Candi: Function and Meaning}. Leiden: Brill.

\vspace{0.5em}
\noindent Takata, H., and Yanase, T. (2022) `Production, Preservation and Dissemination of Archaeological Data in Japan.' \emph{Internet Archaeology} 58.

\vspace{0.5em}
\noindent van Bemmelen, R.W. (1949) \emph{The Geology of Indonesia}. Vol. 1A. The Hague: Government Printing Office.

\vspace{0.5em}
\noindent Whitten, T., Soeriaatmadja, R.E., and Afiff, S.A. (1996) \emph{The Ecology of Java and Bali}. Singapore: Periplus Editions.

\vspace{0.5em}
\noindent Wolters, O.W. (1999) \emph{History, Culture, and Region in Southeast Asian Perspectives}. Rev. ed. Ithaca: Cornell University Southeast Asia Program.
