...
\caption{Polar plot of candi bearings from nearest volcanic peak. The western clustering (mean 298\textdegree{}) is consistent with positioning on the leeward side of prevailing eruption plumes.}
\label{fig:polar}
\end{figure}
...
While 45.1\% of candi lie in Zone A (within 10~km of a volcano), only 12.9\% of inscriptions do.
