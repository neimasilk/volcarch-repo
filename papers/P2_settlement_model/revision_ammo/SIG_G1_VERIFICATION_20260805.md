...
**Run:** 20260805 · **Script:** `revision_ammo/verify_headline_numbers.py` · **Checks:** 64 · **Mismatches:** 4
...
- **E013 hybrid design on common (uniform) background (XGBoost)** - level claim survives but the margin vs DKNS shrinks from +0.122 to ~+0.06
