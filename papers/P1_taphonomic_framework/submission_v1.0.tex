...
The empirical foundation is a four-site calibration. Four archaeological sites with independently documented construction dates and measured burial depths---spanning the Kelud system in East Java (Dwarapala Singosari, \textasciitilde1268~CE) and the Merapi system in Central Java (Candi Sambisari, Kedulan, and Kimpulan, 9th century~CE)---yield sedimentation rates that converge within a factor of two across hundreds of kilometers of separation. Kelud alone has produced 37 confirmed eruptions since 1000~CE \citep{gvp2024}; Merapi is among the world's most persistently active stratovolcanoes \citep{gertisser2012}. That two such geologically distinct systems produce the same order-of-magnitude burial rate is not a given. It is the result.
...
The 666 sites in our database are not a sample of all past sites. They are a sample of sites large enough to protrude above accumulated volcanic sediment and located where archaeologists have repeatedly worked. The Singosari-Majapahit heartland near Malang and Mojokerto has been surveyed intensively since the colonial period; it is also the zone of major Kelud and Arjuno-Welirang deposition. We find sites there because that is where archaeologists looked, and those sites survived because they are large stone monuments. Adding 94 more geocoded sites (E006) shifted the spatial correlation by 0.036---negligible. The database is saturated at a ceiling set by survey effort, not by the actual distribution of past habitation.
...
Empirically grounded estimates for volcanic Java---volcanic burial survival $P = 0.58$, organic material survival $P = 0.20$, survey coverage $P = 0.025$, recognition as pre-Hindu $P = 0.40$, publication probability $P = 0.50$---yield a predicted archaeological visibility of $0.058\%$. The observed rate (3 pre-400~CE sites against \textasciitilde9,600 settlements expected at the demographic model's central estimate) is $0.031\%$. The model matches the data within a factor of two.
...
A note on what this paper does not claim. One might expect volcanic burial to leave a signature in site-type distributions---destroying open-air sites and leaving only caves and rockshelters, which are harder to bury. Comparative analysis of 80 Island Southeast Asian sites across volcanic and non-volcanic regions finds no such difference (Fisher exact $p = 0.760$). Cave dominance is driven by karst availability, not volcanic burial---Kalimantan (non-volcanic, karst-rich) is 100\% cave sites; Java (most volcanically active region) has the lowest proportion of enclosed sites in the dataset. This paper does not argue that volcanic burial shifts site-type ratios. The taphonomic framework presented here rests entirely on burial depth measurements: 32 burial-depth measurements compiled from Dutch colonial-era excavation reports \citep{ov1925}, averaging 2.88~m, a sedimentation model validated at $r = 0.951$ against observed depths, and the 51-pair eruption--site correlation dataset. The depth argument is stronger for having the site-type argument stripped away.
...
Four calibration points. Two volcanic systems. Three hundred and fifty kilometers of separation. The sedimentation rates converge at 2.4--6.2~mm/yr, mean $4.4 \pm 1.2$~mm/yr---consistent enough across geology and geography to establish ongoing volcanic burial as a Java-wide taphonomic baseline, not a site-specific curiosity.
...
The oldest Indonesian kingdom was found at the modern ground surface. It was in Kalimantan, which has no volcanoes. That is not a coincidence.

% ============================================================
\section*{Data Availability Statement}

The archaeological site dataset, DEM derivatives, and analysis scripts are available at \url{https://github.com/neimasilk/volcarch-repo} (to be made public upon acceptance). Raw DEM data from Copernicus GLO-30 are publicly available.
