# ADV-3: Survey Intensity Defense — Revision Ammo for P2
...
ADV-3 adversarial test directly addresses this. After controlling for road distance, BPCB office proximity, and university proximity in a Poisson regression over 703 East Java grid cells:
...
## Citation-ready text
"An adversarial regression test (ADV-3) confirmed that volcanic proximity contributes significant additional explanatory power beyond survey intensity proxies including road accessibility (quasi-Poisson LR p = 0.0015), validating our model's identification of volcanic-zone archaeological gaps as substantive rather than artifactual."
