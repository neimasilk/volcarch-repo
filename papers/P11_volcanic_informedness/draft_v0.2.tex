...
\begin{enumerate}
    ...
    \item An robustness regression confirms that the volcanic-zone site deficit is not solely a survey artifact ($p=0.0015$), validating the premise that undiscovered sites exist in these zones.
\end{enumerate}
