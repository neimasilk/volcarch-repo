...
The candi coordinate dataset, geocoded inscription dataset, tephra-archaeological correlation dataset, and computational scripts used in this study are available at the project repository: \url{https://github.com/mukhlisamien/volcarch}. Precise GPS coordinates of predicted fieldwork targets are restricted to authorized heritage bodies (BPCB, Balai Arkeologi) to prevent unauthorized excavation.
